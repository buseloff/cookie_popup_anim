...
tl.fromTo('.cookie-container', {scale: 0}, {scale: 1.5, ease: "elastic.out(1, 0.4)", duration: 1.5})
tl.fromTo('.cookie', {opacity: 0, x:-50, rotation: '-45deg'}, {opacity: 1, x:0, rotation: '0deg'},'<50%')
tl.fromTo('.text', {x:30, opacity: 0}, {x: 0, opacity: 1}, '<')

//Cookie jump
tl.fromTo('.cookie', {y:0, rotation: '0deg'}, {y: -30,rotation:'-30deg', yoyo: true, repeat: -1})
